        ...
        <div className="flex justify-between items-center mb-4">
          <div className="flex space-x-3">
            <div className="text-xs text-gray-500 flex items-center">
              <svg className="mr-1 text-accent-secondary w-3 h-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              ...
              {portionSize === "large" ? meal.caloriesLarge || Math.round(meal.calories * 1.5) : meal.calories} cal
            </div>
            <div className="text-xs text-gray-500 flex items-center">
              <svg className="mr-1 text-accent w-3 h-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              ...
              {portionSize === "large" ? meal.proteinLarge || Math.round(meal.protein * 1.5) : meal.protein}g protein
            </div>
          </div>
          
          {meal.tags?.includes("vegetarian") && (
            <div className="bg-accent bg-opacity-20 text-accent-foreground text-xs px-2 py-1 rounded-full">
              Vegetarian
            </div>
          )}
        </div>
