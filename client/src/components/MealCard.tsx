    ...
    <Card className={`rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300 relative ${disabled && !isSelected ? 'opacity-60' : ''}`}>
      ...
      <CardContent className="p-4">
        ...
        {meal.tags?.includes("vegetarian") && (
          <div className="inline-flex bg-accent bg-opacity-20 text-accent-foreground text-xs px-2 py-1 rounded-full mb-4">
            Vegetarian
          </div>
        )}
        
        <div className="mt-2 pt-4 border-t border-gray-100 flex justify-between items-center mb-4">
          <div>
        ...
        <div className="pt-3 border-t border-gray-100 flex items-center justify-center gap-4 text-xs text-gray-500">
          <div className="flex items-center">
